...
export default defineEventHandler(() => {
  return [
    ...
    { year: 2020, month: 2,  facility: fw, bank: banks.f, block: 'A', start: 1, end: 70400000 },
    { year: 2020, month: 3,  facility: fw, bank: banks.f, block: 'A', start: 70400001, end: 96000000 },
    { year: 2020, month: 3,  facility: fw, bank: banks.f, block: 'B', start: 1, end: 44800000 },
    { year: 2020, month: 4,  facility: fw, bank: banks.f, block: 'B', start: 44800001, end: 96000000 },
    { year: 2020, month: 4,  facility: fw, bank: banks.f, block: 'C', start: 1, end: 19200000 },
    { year: 2020, month: 5,  facility: fw, bank: banks.f, block: 'C', start: 19200001, end: 96000000 },
    { year: 2021, month: 2,  facility: fw, bank: banks.f, block: 'D', start: 1, end: 96000000 },
    { year: 2021, month: 2,  facility: fw, bank: banks.f, block: 'E', start: 1, end: 76800000 },
    { year: 2022, month: 7,  facility: fw, bank: banks.f, block: 'E', start: 76800001, end: 96000000 },
    { year: 2022, month: 7,  facility: fw, bank: banks.f, block: 'F', start: 1, end: 44800000 },
    { year: 2022, month: 8,  facility: fw, bank: banks.f, block: 'F', start: 44800001, end: 96000000 },
    { year: 2022, month: 9,  facility: fw, bank: banks.f, block: 'G', start: 1, end: 64000000 },
    { year: 2022, month: 10, facility: fw, bank: banks.f, block: 'G', start: 64000001, end: 96000000 },
    { year: 2022, month: 10, facility: fw, bank: banks.f, block: 'H', start: 1, end: 32000000 },
    { year: 2022, month: 11, facility: fw, bank: banks.f, block: 'H', start: 32000001, end: 96000000 },
    { year: 2022, month: 11, facility: fw, bank: banks.f, block: 'I', start: 1, end: 19200000 },
  ] as Run[]
})
